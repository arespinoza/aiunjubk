...
app.get('/api/ask', async (req, res) => {
  ...
  try {
    ...
    var prompt=`Responde primeramente presentandote como Asistente Virtual de la Facultad de Ciencias Económicas de la UNJu, luego agrega una linea en blanco.
                ...
                Si la pregunta es en relación a un libro trata de responder en forma de lista de items, puedes buscar en el título o el autor del libro. Cada item es un libro y en cada linea que salga los autores no retornes los numeros de inventario.
